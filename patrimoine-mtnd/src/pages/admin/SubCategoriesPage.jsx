// src/pages/admin/SubCategoriesPage.jsx
...
export default function SubCategoriesPage() {
        ...
        const fetchPageData = async () => {
            ...
            try {
                ...
                if (generalCategory) {
                    ...
                    // On récupère les sous-catégories liées à la catégorie générale
                    const data = await materialService.fetchSubcategories(
                        generalCategory.id
                    )
                    setSubCategories(data)
                } else {
                    throw new Error(`Type "${type}" introuvable.`)
                }
            } catch (error) {
    ...
    // Le reste de votre code (isLoading, error) est parfait...
