...
export default function ChatPage() {
    ...
    // La fonction pour charger les messages est bonne
    ...
    // CORRECTION : On ajoute la condition ici
    useEffect(() => {
        if (current && current.id) {
            loadMessages(current.id)
        } else {
            setMessages([]) // On vide les messages si aucune conversation n'est sélectionnée
        }
